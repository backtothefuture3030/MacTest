...
class Main(QDialog):
    ...
    def init_ui(self):
        ...
        label_eqaution = QLabel("Equation : ")
        label_solution = QLabel("Solution : ")
        self.equation = QLineEdit("")
        self.solution = QLineEdit("")

        ## layout_equation_solution 레이아웃에 수식, 답 위젯 추가
        layout_equation_solution.addRow(label_eqaution, self.equation)
